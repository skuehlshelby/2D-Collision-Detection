Namespace BVH
    Public Class BoundingVolumeHierarchy
        ...
        Public Sub New(shapes As IShape(), splitMethod As ISplitMethod)
            _root = Build(shapes, splitMethod)
        End Sub

        Private Shared Function Build(shapes As IShape(), splitMethod As ISplitMethod) As BvhBuildNode
        ...
        Private Class BvhBuildNode
            ...
            Public Sub New(shapes As IShape())
                Me.Shapes = shapes
                Bounds = RectF.Union(shapes.Select(Function(shape) shape.Bounds()))
                Left = Nothing
                Right = Nothing
                Axis = Nothing
                IsLeaf = True
            ...
            Public ReadOnly Bounds As RectF
